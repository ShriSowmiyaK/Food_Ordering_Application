    ...
    return (
        <div className="text-center">
            ...
            <div className="text-right mr-72">
                <button data-testid="empty" className="border border-black-100 h-12 hover:bg-gray-100 text-green 800 font-bold py-2 px-4 rounded-full" onClick={() => dispatch(emptyItems())}>
                    EMPTY CART
            </button>
            </div>
